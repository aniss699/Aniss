  ...
  const demoAccounts = [
    {
      ...
      name: 'Marie Dubois',
      role: 'CLIENT',
      description: 'Compte client démo avec projets actifs',
      icon: <User className="w-5 h-5" />,
      color: 'blue',
      stats: ['15 projets postés', '€45k budget total', '4.6★ notation']
    },
    {
      ...
      role: 'PRO',
      description: 'Prestataire expert avec portfolio complet',
      icon: <Briefcase className="w-5 h-5" />,
      color: 'green',
      stats: ['156 projets réalisés', '94% taux succès', '4.8★ notation']
    },
    {
